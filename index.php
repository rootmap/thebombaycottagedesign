...
<html>
    <head>
        ...
        <title>5 Star Rating The Bombay Cottage Indian Restaurant and Takeaway in Stamford - Home</title>
        <meta name="description" content="5 Star Rating The Bombay Cottage Indian Restaurant and Takeaway in Stamford - Home">
                            ...
                            <div class="cell-9">
                                ...
                                <div class="cell-6">
                                    <p class="margin-bottom-0">  OUR MOTO- Our taste is simple,  We like the Best.!!                                                <br> <br>
                                        <img src="images/signature.jpg" alt="signature of the manager"> <br>
                                        ………………………… <br> (Manager) <br>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="cell-3 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="cus_image uppercase">
                                    <a href="#">
                                    <h3 class="block-head ">Trip advisor</h3>
                            ...
                            <div class="cell-3 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="cus_image uppercase">
                                    <a href="#">
                                    <h3 class="block-head">Food Hygiene</h3>
                            ...
                            <div class="cell-3 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="cus_image uppercase">
                                <a href="#">
                                    <h3 class="block-head">Group Booking Offer</h3>
                            ...
                            <div class="cell-3 fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
                                <div class="cus_image uppercase">
                                <a href="#">
                                    <h3 class="block-head">Table Booking</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="cell-6 animated fadeInRight" data-animate="fadeInRight">
                                <div class="cus_pad_top">
                                    <img class="" src="images/devices_1.png" alt="free delivery offer">
                                </div>
                            </div>
